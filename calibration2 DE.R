...
pds_new_all_DE= subset(pds_new_all_DE, select=-c(Group.1, tot_sf_catch, tot_bsb_catch, tot_wf_catch))
...
costs_new_all_DE = as.data.frame(bind_rows(costs_new_DE[[1]], costs_new_DE[[2]]))
