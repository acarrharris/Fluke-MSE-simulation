...
pds_new_all_MD= subset(pds_new_all_MD, select=-c(Group.1, tot_sf_catch, tot_bsb_catch, tot_wf_catch))
...
costs_new_all_MD = as.data.frame(bind_rows(costs_new_MD[[1]], costs_new_MD[[2]]))
