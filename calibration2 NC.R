...
pds_new_all_NC = as.data.frame(bind_rows(pds_new[[3]], pds_new[[4]], pds_new[[5]]))
pds_new_all_NC[is.na(pds_new_all_NC)] = 0
pds_new_all_NC$state = state1
pds_new_all_NC$alt_regs = 0
pds_new_all_NC= subset(pds_new_all_NC, select=-c(Group.1, tot_sf_catch, tot_bsb_catch, tot_wf_catch, tot_rd_catch))
...
costs_new_all_NC = as.data.frame(bind_rows(costs_new_NC[[3]], costs_new_NC[[4]], costs_new_NC[[5]]))
