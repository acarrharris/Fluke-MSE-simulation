...
pds_new_all_NY = as.data.frame(bind_rows(pds_new[[1]], pds_new[[2]],pds_new[[3]],pds_new[[4]], pds_new[[5]]))
pds_new_all_NY[is.na(pds_new_all_NY)] = 0
pds_new_all_NY$state = state1
pds_new_all_NY$alt_regs = 0
pds_new_all_NY= subset(pds_new_all_NY, select=-c(Group.1, tot_sf_catch, tot_bsb_catch, tot_scup_catch))
...
costs_new_all_NY = as.data.frame(bind_rows(costs_new_NY[[1]], costs_new_NY[[2]],costs_new_NY[[3]],costs_new_NY[[4]], costs_new_NY[[5]]))
