...
pds_new_all_RI= subset(pds_new_all_RI, select=-c(Group.1, tot_sf_catch, tot_bsb_catch, tot_scup_catch))
...
costs_new_all_RI = as.data.frame(bind_rows(costs_new_RI[[2]],costs_new_RI[[3]],costs_new_RI[[4]]))
